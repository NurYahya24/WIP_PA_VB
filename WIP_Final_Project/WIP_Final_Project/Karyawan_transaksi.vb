...
Public Class Karyawan_transaksi
    ...
    Sub tampilData(ByVal idTrans As Integer)
        ...
        Karyawan_Main.topLabel.Text = "Detail Pesanan__________________"
        With Karyawan_DetailTransaksi
            .TopLevel = False
            Karyawan_Main.pnCanvas.Controls.Add(Karyawan_DetailTransaksi)
            .BringToFront()
            .Show()
        End With
