...
Public Class Owner_Barang
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        Owner_Main.topLabel.Text = "Detail Barang__________________"
        Owner_Main.pnCanvas.Controls.Clear()
        With Pelanggan_DetailBarang
            .TopLevel = False
            Owner_Main.pnCanvas.Controls.Add(Pelanggan_DetailBarang)
            .BringToFront()
            .Show()
        End With
        ...
        Pelanggan_DetailBarang.btnAdd.Visible = False
        Pelanggan_DetailBarang.btnDel.Visible = False
