...
Public Class Pelanggan_Transaksi
    ...
    Sub tampilData(ByVal idTrans As Integer)
        ...
        Pelanggan_Main.topLabel.Text = "Detail Pesanan__________________"
        With Pelanggan_DetailTransaksi
            .TopLevel = False
            Pelanggan_Main.pnCanvas.Controls.Add(Pelanggan_DetailTransaksi)
            .BringToFront()
            .Show()
        End With
        Pelanggan_DetailTransaksi.idTransaksi = idTrans
        Pelanggan_DetailTransaksi.refreshPage()
        Pelanggan_DetailTransaksi.readDB()
    End Sub


    Private Sub lbStatus1_Click(sender As Object, e As EventArgs) Handles lbStatus1.Click
        tampilData(lbId1.Text)
        Pelanggan_DetailTransaksi.pbProfil.ImageLocation = alamatProfil + dgvDataTransaksi.Rows(0).Cells(6).Value.ToString
        Pelanggan_DetailTransaksi.lbNamaUser.Text = lbNama1.Text
        Pelanggan_DetailTransaksi.lbAlamat.Text = lbAlamat1.Text
    End Sub
    ...
    Private Sub lbTanggal2_Click(sender As Object, e As EventArgs) Handles lbTanggal2.Click
        ...
        Pelanggan_DetailTransaksi.pbProfil.ImageLocation = alamatProfil + dgvDataTransaksi.Rows(1).Cells(6).Value.ToString
        Pelanggan_DetailTransaksi.lbNamaUser.Text = lbNama2.Text
        Pelanggan_DetailTransaksi.lbAlamat.Text = lbAlamat2.Text
    End Sub
    ...
    Private Sub lbStatus3_Click(sender As Object, e As EventArgs) Handles lbStatus3.Click
        ...
        Pelanggan_DetailTransaksi.pbProfil.ImageLocation = alamatProfil + dgvDataTransaksi.Rows(2).Cells(6).Value.ToString
        Pelanggan_DetailTransaksi.lbNamaUser.Text = lbNama3.Text
        Pelanggan_DetailTransaksi.lbAlamat.Text = lbAlamat3.Text
    End Sub
    ...
    Private Sub lbTanggal4_Click(sender As Object, e As EventArgs) Handles lbTanggal4.Click
        ...
        Pelanggan_DetailTransaksi.pbProfil.ImageLocation = alamatProfil + dgvDataTransaksi.Rows(3).Cells(6).Value.ToString
        Pelanggan_DetailTransaksi.lbNamaUser.Text = lbNama4.Text
        Pelanggan_DetailTransaksi.lbAlamat.Text = lbAlamat4.Text
    End Sub
